    ...
    for (y <- 0 to 19) {
      for (x <- 0 to 36) {
        ...
        map(mapCounter) match {
          ...
          case 24  => stuff :+= new OverworldImmovable(countX, countY, "hillTop")
          ...
          case 50  => stuff :+= new MapPortal(countX, countY, 800, 200, 0)
          ...
          //added
          case 7   => stuff :+= new OverworldMovable(countX, countY, "pcfloor")
          case 8   => stuff :+= new OverworldMovable(countX, countY, "seat")

          case 17  => stuff :+= new OverworldImmovable(countX, countY, "bed0")
          case 18  => stuff :+= new OverworldImmovable(countX, countY, "bed1")
          case 19  => stuff :+= new OverworldImmovable(countX, countY, "bookshelf")
          case 13  => stuff :+= new OverworldImmovable(countX, countY, "pc")
          case 150  => stuff :+= new OverworldImmovable(countX, countY, "table1")
          case 160  => stuff :+= new OverworldImmovable(countX, countY, "table2")
          
          case 46  => stuff :+= new NPC(countX, countY, "nurseNPC")
        }
        countX += 25
        mapCounter += 1
      }
